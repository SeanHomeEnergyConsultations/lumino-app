...
export async function getLeadDetail(
  ...
  const item: LeadDetailItem = {
    ...
    decisionMakerStatus: (lead.decision_maker_status as string | null) ?? null,
    preferredChannel: (lead.preferred_channel as string | null) ?? null,
    bestContactTime: (lead.best_contact_time as string | null) ?? null,
    textConsent: (lead.text_consent as boolean | null) ?? null,
    objectionType: (lead.objection_type as string | null) ?? null,
    billReceived: (lead.bill_received as boolean | null) ?? null,
    proposalPresented: (lead.proposal_presented as boolean | null) ?? null,
    appointmentOutcome: (lead.appointment_outcome as string | null) ?? null,
    rescheduleReason: (lead.reschedule_reason as string | null) ?? null,
    cancellationReason: (lead.cancellation_reason as string | null) ?? null,
    engagementScore: (lead.engagement_score as number | null) ?? null,
    cadenceTrack: (lead.cadence_track as string | null) ?? null,
