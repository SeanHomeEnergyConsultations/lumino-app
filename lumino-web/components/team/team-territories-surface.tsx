...
export function TeamTerritoriesSurface() {
  const {
    loadingList,
    territories,
    selectedTerritoryId,
      ...
      <section className="rounded-[2rem] border border-slate-200/80 bg-white/80 p-5 shadow-panel backdrop-blur">
        ...
        <div className="mt-6 rounded-3xl border border-slate-200 bg-slate-50 p-4">
          ...
          <button
            ...
            disabled={!hasAccessToken || territoryState === "saving" || !createName.trim()}
            ...
            <div className="mt-5 grid gap-4 lg:grid-cols-[1fr_1fr]">
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                ...
                <button
                  ...
                  disabled={!hasAccessToken || territoryState === "saving" || !detailName.trim()}
              ...
              <div className="rounded-3xl border border-slate-200 bg-slate-50 p-4">
                ...
                <p className="mt-1 text-xs text-slate-500">Search by address and attach properties to this territory.</p>
                <input
                  type="text"
                  value={searchTerm}
